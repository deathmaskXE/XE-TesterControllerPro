class XEXboxSeriesComplete{
 ...
 bind(){document.querySelector(".guide").textContent="X";this.$("openXboxRecal").querySelector("strong").textContent="RECALIBRAR CONTROL XBOX SERIES";this.$("open1708Recal").querySelector("strong").textContent="RECALIBRAR CONTROL XBOX ONE 1708";this.$("openPsRecal").querySelector("strong").textContent="RECALIBRAR CONTROL DUALSENSE / DUALSHOCK 4";this.$("xbConnect").onclick=()=>this.connect();this.$("xbAuto").onclick=()=>this.startTest();this.$("xbCalibrate").onclick=()=>this.showCal();this.$("xbCalGo").onclick=()=>this.calibrate();this.$("xbPdf").onclick=()=>this.pdf();this.$("xbRestoreDownload").onclick=()=>{this.$("xbRestore").classList.remove("hidden");this.$("xbRestore").scrollIntoView({behavior:"smooth",block:"center"})}}
