class XEXboxSeriesComplete{
 ...
 draw(id,x,y){let c=this.$(id),g=c.getContext("2d"),w=c.width,h=c.height;g.clearRect(0,0,w,h);g.strokeStyle="#718087";g.lineWidth=2;g.beginPath();g.arc(w/2,h/2,w*.39,0,Math.PI*2);g.stroke();g.strokeStyle="#aeb9bf";g.beginPath();g.moveTo(w/2,18);g.lineTo(w/2,h-18);g.moveTo(18,h/2);g.lineTo(w-18,h/2);g.stroke();g.fillStyle="#00bcd4";g.beginPath();g.arc(w/2+x*w*.36,h/2+y*h*.36,7,0,Math.PI*2);g.fill()}
